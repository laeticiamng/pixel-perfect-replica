...
import { innerGlowVertexShader, innerGlowFragmentShader } from './shaders/innerGlowFragment.glsl';
...
function OrganicSphere({ scrollRef, detail, orbOffset, quality }: OrganicSphereProps) {
...
export function OrganicOrb({
  ...
  return (
    <>
      ...
      <OrganicSphere scrollRef={scrollRef} detail={icosahedronDetail} orbOffset={orbOffset} quality={quality} />
    </>
  );
}

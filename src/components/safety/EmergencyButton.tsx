...
export function EmergencyButton({ onTrigger, className }: EmergencyButtonProps) {
  ...
  const triggerEmergency = async () => {
    ...
    try {
      ...
      console.error('Could not get position for emergency');
    }
  ...
  return (
    <>
      <button
        ...
        aria-label="Bouton d'alerte d'urgence - Maintenir pour activer"
      >
        {/* Progress ring */}
        <svg
        ...
        <Shield className={cn(
          "h-6 w-6 text-primary-foreground relative z-10 transition-transform",
        ...
        <DialogContent className="glass-strong border-destructive/50">
          <DialogHeader>
            ...
            <DialogDescription className="text-muted-foreground">
              Ta position GPS a été préparée pour être partagée.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-4 mt-4">
            ...
            <p className="text-xs text-muted-foreground text-center">
              En cas de danger réel, appelle immédiatement les secours.
            </p>

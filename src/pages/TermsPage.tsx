        ...
        <div className="glass rounded-xl p-6 space-y-4">
          ...
          <section className="space-y-3">
            ...
            <p className="text-muted-foreground">
              En utilisant SIGNAL, vous acceptez d'être lié par ces conditions d'utilisation. 
          ...
          <section className="space-y-3">
            ...
            <p className="text-muted-foreground">
              SIGNAL est une application permettant aux utilisateurs de signaler leur disponibilité 
          ...
          <section className="space-y-3">
            ...
            <p className="text-muted-foreground">
              Vous devez créer un compte pour utiliser SIGNAL. Vous êtes responsable de maintenir 
          ...
          <section className="space-y-3">
            ...
            <p className="text-muted-foreground">
              Vous vous engagez à utiliser SIGNAL de manière respectueuse. Sont interdits :
            </p>
          ...
          <section className="space-y-3">
            ...
            <p className="text-muted-foreground">
              SIGNAL et tout son contenu sont protégés par les droits d'auteur et autres droits 
          ...
          <section className="space-y-3">
            ...
            <p className="text-muted-foreground">
              SIGNAL est fourni "tel quel". Nous ne garantissons pas que l'application sera 
          ...
          <section className="space-y-3">
            ...
            <p className="text-muted-foreground">
              ...
              <a href="mailto:legal@signal-app.fr" className="text-coral ml-1">legal@signal-app.fr</a>
            </p>
          </section>
        </div>

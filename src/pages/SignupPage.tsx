...
export default function SignupPage() {
  ...
  const { signUp, signInWithOAuthSupabase, isAuthenticated } = useAuth();
        ...
        <div className="max-w-md mx-auto w-full flex-1 flex flex-col justify-center relative z-10">
          <div className="space-y-6 animate-slide-up text-center">
            ...
            <div className="space-y-3 pt-4">
              ...
              <Button onClick={() => navigate('/login')} className="w-full h-14 text-lg font-semibold bg-coral hover:bg-coral-dark text-primary-foreground rounded-xl glow-coral">
        ...
        <div className="flex-1 flex flex-col justify-center">
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div className="text-center mb-8">
              ...
              <p className="text-muted-foreground">{t('auth.fillInfo')}</p>
            </div>
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                <Input
                  ...
                  className={cn("h-14 bg-deep-blue-light border-border text-foreground placeholder:text-muted-foreground rounded-xl", errors.firstName && "border-destructive")}
              ...
              <Button type="submit" disabled={isLoading} className="w-full h-14 text-lg font-semibold bg-coral hover:bg-coral-dark text-primary-foreground rounded-xl glow-coral">
                {isLoading ? <Loader2 className="h-5 w-5 animate-spin" /> : t('landing.createMyAccount')}
              </Button>
            ...
            <div className="text-center pt-2">
              <span className="text-sm text-muted-foreground">
                ...
                <Link to="/login" className="text-coral font-medium hover:text-coral-dark transition-colors">
                  {t('auth.signIn')}
                </Link>
              </span>
            </div>
